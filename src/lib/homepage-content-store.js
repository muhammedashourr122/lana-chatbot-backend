...
const DEFAULT_HOMEPAGE_CONTENT = {
  ...
  offers: {
    box1: {
      ...
      title: "Buy 3, <em>Get 2 Free</em>",
      note: "Stock up on your favorites and share the rest — free shipping included.",
      code: "EXPLORE5",
      buttonText: "Shop The Offer",
      buttonLink: "/collections/all",
    },
    box2: {
      eyebrow: "Members Perk",
      title: "Save <em>10% Today</em>",
      note: "Buy 2 or more products and save automatically at checkout.",
      code: "SAVE10",
      buttonText: "Shop The Offer",
      buttonLink: "/collections/all",
    },
